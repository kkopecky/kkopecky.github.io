...
const Navbar = () => {
	...
	const renderNavItem = (href: string, label: string) => (
		<li>
			<a
				href={href}
				className="block py-2 pl-3 pr-4 rounded md:bg-transparent md:text-[#4f2569] md:p-0 hover:text-gray-400 transition duration-300 text-xl"
				aria-current="page"
			>
				{label}
			</a>
		...
		<nav className="bg-white border-gray-200 dark:bg-gray-900">
			<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
				...
				<button
					...
					type="button"
					className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-[#4f2569] rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
